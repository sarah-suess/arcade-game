...
# 1 "start04.h" 1
# 21 "start04.h"
extern const unsigned short start04Bitmap[19200];


extern const unsigned short start04Pal[256];
# 5 "main.c" 2
# 1 "sound.h" 1
# 76 "sound.h"
enum {
...
void goToStart() {
    DMANow(3, &start04Pal, ((unsigned short *)0x5000000), (1 << 31 | (512 / 2)));
    drawFullscreenImage4(start04Bitmap);

    char letters[11] = {'P', 'R', 'E', 'S', 'S', ' ', 'S', 'T','A','R','T'};
    unsigned short colors[11] = {0x0a1, 0x0a1, 0x0a1, 0x0a1, 0x0a1, (((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), 0x0a1, 0x0a1, 0x0a1, 0x0a1, 0x0a1};
    int col = 55;
    int spacing = 12;
    for(int i = 0; i < 11; i++){
