...
# 36 "game.h"
enum {BLACKID=(256-1)};
extern unsigned short colors[1];
...
# 21 "player01.h"
extern const unsigned short player01Bitmap[280];


extern const unsigned short player01Pal[256];
# 8 "game.c" 2
# 1 "player04.h" 1
# 21 "player04.h"
extern const unsigned short player04Bitmap[280];


extern const unsigned short player04Pal[256];
# 9 "game.c" 2
# 1 "enemy04.h" 1
# 21 "enemy04.h"
extern const unsigned short enemy04Bitmap[280];


extern const unsigned short enemy04Pal[256];
# 10 "game.c" 2
# 1 "sound.h" 1
# 76 "sound.h"
enum {
...
# 1 "star04.h" 1
# 21 "star04.h"
extern const unsigned short star04Bitmap[32];


extern const unsigned short star04Pal[256];
# 12 "game.c" 2
# 1 "lib.h" 1
# 13 "game.c" 2
...
void initGame() {
    ...
    unsigned short colors[1] = {(((0) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10)};
    DMANow(3, enemy04Pal, ((unsigned short *)0x5000000), 16);
    DMANow(3, player01Pal + 16, ((unsigned short *)0x5000000) + 16, 16);
    DMANow(3, player04Pal + 32, ((unsigned short *)0x5000000) + 32, 16);
    DMANow(3, star04Pal + 32 + 16, ((unsigned short *)0x5000000) + 32 + 16, 16);



    for (int i = 0; i < 1; i++) {
        ((unsigned short *)0x5000000)[256-1 +i] = colors[i];
    }
}
...
void updatePlayer() {
    ...
    if ((~(buttons) & ((1<<4))) && (player.x < 212)) {
        player.x += 4;
    }
    if ((~(buttons) & ((1<<6))) && (player.y > 0)) {
        player.y -= 4;
    }
    if ((~(buttons) & ((1<<7))) && (player.y < 139)) {
        player.y += 4;
    }
    ...
    if (player.powerup) {
        ...
        if (timeTrack >= 0 && timeTrack <= 10) {
            *(volatile u16*)0x04000062 = (((8) & 15) << 12) | (((3) & 7) << 8);
            *(volatile u16*)0x04000060 = ((5) & 7) | (((15) & 7) << 4) | (1 << 3);
            *(volatile u16*)0x04000064 = NOTE_G3 | (1<<15) | (1<<14);
        }
        if (timeTrack > 10 && timeTrack <= 20) {
            *(volatile u16*)0x04000062 = (((8) & 15) << 12) | (((3) & 7) << 8);
            *(volatile u16*)0x04000060 = ((5) & 7) | (((15) & 7) << 4) | (1 << 3);
            *(volatile u16*)0x04000064 = NOTE_G4 | (1<<15) | (1<<14);
        }
        if (timeTrack >= 200) {
            player.dodge = 0;
            player.powerup = 0;
